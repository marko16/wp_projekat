Vue.component('EditEvent', {
    ...
    mounted() {
        ...
        then(response => {
            ...
            this.price = this.event.regularPrice
            this.street = this.event.location.street
            this.number = this.event.location.number
            this.city = this.event.location.city
            this.zipcode = this.event.location.zipcode
        })
    },
        ...
        async editEvent(e) {
            ...
            axios.post("/editEvent", {
                ...
                .then(response => {
                    ...
                    if(response.data) alert("You have successfully edited this event!")
    ...
    <div class="row justify-content-center">
      <div class="col-md-6">
        <div class="card">
          <div class="card-header" style="background-color:#333333; color:white">Edit event</div>
          <div class="card-body">
            <form name="myform" @submit="editEvent">
